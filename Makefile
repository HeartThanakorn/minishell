...
# Source files
BUILTIN_SRCS = $(BUILTIN_DIR)/builtins.c $(BUILTIN_DIR)/echo.c $(BUILTIN_DIR)/pwd.c $(BUILTIN_DIR)/cd.c $(BUILTIN_DIR)/env.c $(BUILTIN_DIR)/exit.c $(BUILTIN_DIR)/export.c $(BUILTIN_DIR)/unset.c $(BUILTIN_DIR)/env_utils.c
